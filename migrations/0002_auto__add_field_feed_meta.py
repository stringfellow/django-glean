...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('glean_feed', 'meta', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.meta'
        db.delete_column('glean_feed', 'meta')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 17, 32, 32, 490830)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 16, 17, 32, 32, 490677)'}),

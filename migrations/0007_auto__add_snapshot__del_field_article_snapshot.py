...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('glean_snapshot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('article', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['glean.Article'])),
            ('body', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('file', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True)),
        ))
        db.send_create_signal('glean', ['Snapshot'])

        # Deleting field 'Article.snapshot'
        db.delete_column('glean_article', 'snapshot')


    def backwards(self, orm):
        
        # Deleting model 'Snapshot'
        db.delete_table('glean_snapshot')

        # Adding field 'Article.snapshot'
        db.add_column('glean_article', 'snapshot', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 19, 12, 1, 22, 115203)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 19, 12, 1, 22, 115047)'}),

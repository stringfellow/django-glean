...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('glean_feed', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 1, 18, 16, 31, 36, 501081)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feed.last_updated'
        db.delete_column('glean_feed', 'last_updated')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 18, 16, 31, 36, 506709)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 1, 18, 16, 31, 36, 506591)'}),
